...
def main():
    ...
    # Go to position 1
    goToPosition(navigator, 'Position 1', table_trash_positions['position_1'])
    ...
    if result == TaskResult.SUCCEEDED:
        print('Got trash table from ' + request_item_location + '! Bringing trash table to shipping destination: ' + request_destination + '...')
        
        # Go to position backroom 2
        goToPosition(navigator, 'Backroom', shipping_destinations['backroom_2'], 'map')
